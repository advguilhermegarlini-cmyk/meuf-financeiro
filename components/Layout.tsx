...
export const Card: React.FC<React.HTMLAttributes<HTMLDivElement>> = ({ children, className = '', ...props }) => (
  <div className={`bg-github-surface border border-github-border rounded-[16px] shadow-md w-full transition-all duration-200 ${className}`} {...props}>
    {children}
  </div>
);
...
export const Button = ({ 
  ...
  const base = "min-h-[40px] px-4 sm:px-5 py-2 sm:py-3 rounded-[8px] font-medium text-sm sm:text-base transition-all focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-github-bg disabled:opacity-50 disabled:cursor-not-allowed inline-flex items-center justify-center";
  const variants = {
    ...
    ghost: "bg-transparent text-github-primary hover:underline px-2 sm:px-3 py-1 min-h-auto"
  };
